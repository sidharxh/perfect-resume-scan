...
{ "overall_score": , "ats_score": , "total_issues": , "sections": [ { "title": "

", "score": , "items": [ { "name": "", "score": , "status": "pass/fail", "comment": "<short witty comment (dbrand-style sarcasm)>", "suggestion": "" } ] } ] }
Guidelines:
...
Example for one category item: { "name": "Spelling & Grammar", "score": 70, "status": "fail", "comment": "Why let a typo decide your career?", "suggestion": "Run a spell check. Seriously." }
